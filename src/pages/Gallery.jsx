                ...
                {activeLightbox && (
                    ...
                    >
                        <button
                            ...
                            className="absolute top-4 right-4 p-2 bg-white/10 text-white hover:bg-white/20 rounded-full transition-colors z-50 cursor-pointer"
                        >
                            <X size={24} />
                        </button>
                        ...
                        <motion.div
                            ...
                            className="max-w-5xl max-h-[80vh] overflow-hidden rounded-xl relative flex items-center justify-center"
                            onClick={(e) => e.stopPropagation()}
                        >
                            <img src={activeLightbox.src} alt={activeLightbox.title} className="max-w-full max-h-[80vh] object-contain" />
                        </motion.div>

                        <div className="text-center mt-4 text-white max-w-md px-2 pointer-events-none">
                            <h3 className="font-serif text-lg font-bold tracking-wide">{activeLightbox.title}</h3>
                            <p className="text-white/60 text-xs flex items-center justify-center gap-1 mt-1 font-medium">
                                <MapPin size={12} className="text-primary" /> {activeLightbox.location}
                            </p>
                        </div>
                    </motion.div>
                )}
