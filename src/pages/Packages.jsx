...
export default function Packages() {
    ...
    useEffect(() => {
        ...
        const preventBrowserSwipe = (e) => {
            // If the scroll is mostly horizontal, prevent the default browser action (back/forward)
    ...
    const handleCardClick = () => {
        if (filteredPackages[currentIndex]) {
            // FIXED 404: Updated from /package/ to /packages/
    ...
    return (
        <div className="w-full bg-background min-h-[calc(100dvh-4rem)] flex flex-col items-center pt-2 pb-24 md:pb-4 md:pt-6 font-sans relative">

            {/* Top Bar - Fades and slides up on scroll */}
            <motion.div
            ...
            {/* Immersive Swipeable Deck Area - Added overscroll-x-none and ref for browser swipe prevention */}
            <div className="flex-1 w-full max-w-sm md:max-w-5xl relative z-10 px-2 md:px-0">
                ...
                >
                    ...
                    {/* Mobile Swipe Hints (Disappears after first swipe) */}
